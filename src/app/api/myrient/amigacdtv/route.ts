...
export async function GET() {
  try {
    const response = await fetch(
      "https://myrient.erista.me/files/Redump/Commodore%20-%20Amiga%20CDTV/",
    ...
    for (const row of rows) {
      ...
      if (linkMatch) {
        ...
        const base = "https://myrient.erista.me/files/Redump/Commodore%20-%20Amiga%20CDTV/";
    ...
    console.error("Error fetching Myrient Amiga CDTV ROMs:", error);
