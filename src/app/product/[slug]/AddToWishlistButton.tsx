  ...
  return (
    <>
      ...
      <button
        ...
        disabled={isLoading}
        className={cn(
          "hidden lg:inline-flex nk-btn nk-btn-outline",
      ...
      >
        ...
        <span className="nk-btn-content flex items-center gap-2">
          ...
          <span>{isLoading ? "Loading..." : inWishlist ? "In Wishlist" : "Add to Wishlist"}</span>
        </span>
      </button>
      ...
      <button
        ...
        disabled={isLoading}
        className={cn(
          "lg:hidden h-10 px-4 flex items-center justify-center gap-2 border text-sm transition-colors",
          inWishlist 
