      ...
      <div className="container">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-6 md:gap-8 mb-10 text-center md:text-left">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="https://www.facebook.com/people/Darkpoint/61587015286928/" target="_blank" rel="noopener noreferrer" className="text-white/50 hover:text-[var(--color-main-1)] transition-colors text-sm cursor-pointer">
                  Facebook
                </a>
              </li>
              <li>
