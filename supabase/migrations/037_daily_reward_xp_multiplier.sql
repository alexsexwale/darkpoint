-- ============================================
-- Migration 037: Apply XP multiplier to daily login rewards
-- ============================================
-- The daily login reward was not applying active XP multipliers.
-- This migration updates claim_daily_reward_v2 to check for and apply
-- any active XP multiplier (e.g., 2x boost from spin wheel).
...
BEGIN
  ...
  EXCEPTION WHEN undefined_table THEN
    -- Table doesn't exist, no multiplier
  ...
  -- Update multiplier tracking if active and bonus was applied
